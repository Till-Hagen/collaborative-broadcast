...
def CreateMisoSenderFigure(_model, _colors, _receiverPos, _wavelength,_pathLoss,_b, _dimension, _plotTyp):
    ...
    if(_dimension == '3d'):
        ...
        cs = ax.scatter(XX, YY,_receiverPos[2], c=Z, s=0.1,cmap=plt.get_cmap(_colors), alpha=1)
        ax.set_zlabel('Z')
        ax.set_zlim(-1, 1)
    else:
