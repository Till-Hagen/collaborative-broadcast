...
from ReceiverDisc.receiverDiscSimulation import Simulate
from ReceiverDisc.receiverDiscVisualization import CreateFigure
...
def GetFigure(_valuesChange, _debug = False):
    ...
    receiverPos = session['receiverPosMimo_RD']
