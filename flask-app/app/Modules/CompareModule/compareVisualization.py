...
def CreateFigure(_algorithms, _data, _energie, _signalType, _minReceivedValue, _range, _originRadius, _distanceToOrigin):
    ...
    ax.set(xlabel='Minimum Signal Value', ylabel='#Receiver')
    ax.grid()
    ...
    legend1 = ax.legend(_energie, bbox_to_anchor=(0., 1.02, 1., .102), loc='lower left',title="Sum of Amplitudes",
