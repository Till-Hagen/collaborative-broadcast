...
class HistogramFrom(FlaskForm):
    ...
    rangeMin = FloatField('min', validators=[InputRequired()])
    rangeMax = FloatField('max', validators=[InputRequired()])
    rangeTop = FloatField('top', validators=[InputRequired()])
    saveData = BooleanField('isotropic')
    ...
    def __init__(self, *args, **kwargs):
        super(HistogramFrom, self).__init__(*args, **kwargs)
