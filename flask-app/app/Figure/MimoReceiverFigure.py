...
def CreateMimoReceiverFigure(_model:float, _colors, _receiverPos, _radius, _orientation, _vmin, _vmax, _plotTyp, _dimension, _logScale):
...
def InitFigureScatter3d(ax, fig, _Z ,_model, _colors, _receiverPos, _radius, _orientation, _vmin, _vmax):
    Z = _Z
    if(session['cutOrigin']):
        originRadius = session['originRadius']
