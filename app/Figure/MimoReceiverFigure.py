...
def CreateMimoReceiverFigure(_model, _colors, _receiverPos, _radius, _orientation, _vmin, _vmax, _plotTyp, _dimension, _logScale):
...
def InitFigureScatter3d(ax, fig, Z,_model, _colors, _receiverPos, _radius, _orientation, _vmin, _vmax):
    # if(_vmin != None):
...
def InitFigureScatter2d(ax, fig, Z,_model, _colors, _receiverPos, _radius, _orientation, _vmin, _vmax):
